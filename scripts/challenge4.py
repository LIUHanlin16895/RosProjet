...
#        print('Challenge 1')
    ...
    min_front = min(min(tab_front), 0.5)
    
#    if challenge == 2:   
    if mean_front > 0.28: #0.25
    	
        linear_x = 0.1
        angular_z = 0
    else:
        if mean_leftFront > (mean_rightFront-0.1):
            linear_x = 0.01
            angular_z = 0.5
...
if __name__ == '__main__':
    try:
        ...
        rospy.Subscriber("/raspicam_node/image/compressed", Image, callback_follow)
